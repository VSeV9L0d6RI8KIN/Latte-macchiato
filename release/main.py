...
class Clss(QMainWindow, Ui_MainWindow2):
    ...
    def ins(self):
        ...
        if not flag:
            ...
            if self.ui2.lineEdit.text() and self.ui2.lineEdit_2.text() and self.ui2.lineEdit_3.text() \
                    and self.ui2.lineEdit_4.text() and self.ui2.lineEdit_5.text() and self.ui2.lineEdit_6.text():
